...
public:
	...
	static Mesh* GenerateQuadx20(const std::string &meshName, Color color, float length = 1.f);
	static Mesh* GenerateQuadx10(const std::string &meshName, Color color, float length = 1.f);
